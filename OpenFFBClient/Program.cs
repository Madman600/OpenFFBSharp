...
namespace OpenFFBClient
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //openFFBoard.System.SetDebug(false);
            ...
            #region FFB EFFECTS
            Console.WriteLine("---ExtFFB EFFECTS---");
            Console.WriteLine("ID: {0}", openFFBoard.ExtFFB.GetId());
            //    Console.WriteLine("Name: {0}", openFFBoard.ExtFFB.GetName());
            ...
            Console.WriteLine("Reset Effects Manager: {0}", openFFBoard.ExtFFB.reset());

            Console.WriteLine("Enable EXT FFB: {0}", openFFBoard.ExtFFB.SetFFBState(1));
            /* Normal effects
...
Conditional effects
    ...
    Friction = 11
            ...
            */
            var effectIndex = openFFBoard.ExtFFB.SetNewEffect(4);

            Console.WriteLine("Create new sine effect, index: {0}", effectIndex);

            Console.WriteLine("set magnitude: {0}", openFFBoard.ExtFFB.setMagnitude(10000, effectIndex));
            Console.WriteLine("set period: {0}", openFFBoard.ExtFFB.setPeriod(50, effectIndex));
            Console.WriteLine("enable effect: {0}", openFFBoard.ExtFFB.setState(1, effectIndex));
            #endregion
            ...
            Console.ReadKey();
            Console.WriteLine("disable effect: {0}", openFFBoard.ExtFFB.SetFFBState(0));
